...
{
    int num,position,c;
    printf("\nEnter the location where you wish to update an element (1 to %d):",size);
    scanf("%d", &position);
...
{
    int position,c;
    printf("\nEnter the location where you wish to delete an element(1 to %d):",size+1);
    scanf("%d", &position);
...
void inserting (int a[],int size)
{
    ...
    printf("Enter the location where you wish to insert an element (1 to %d):",size);
    scanf("%d", &position);
